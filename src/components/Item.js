    ...
    <div className="w-full border-b-2 border-orange-500 p-2">
      <div className="w-full flex gap-3 mb-3">
        <Link
          ...
          className="w-[30%] cursor-pointer  gap-[2px] relative flex flex-wrap"
          replace={true}
        >
        ...
        <div className="w-[70%]">
          <div className="flex gap-1">
            <Link
              to={`/chi-tiet/${formatVietnameseToString(title)}/${id}`}
              className=" w-full inline-block cursor-pointer text-[red] hover:underline"
              replace={true}
            >
              {star === 5 ? (
          ...
          <div className="flex my-2 text-sm justify-between w-full gap-2">
            <div className="flex gap-2">
              <h2 className="text-[#61d9ac]">{attributes.price}</h2>
              <span>{attributes.acreage}</span>
              <a className="block">{`${address[address.length - 2]},${
