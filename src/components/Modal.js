...
function Modal({
  ...
  const handleBeforeSubmit = (e) => {
    ...
    handleSubmit(
      e,
      {
        ...
        [name]: `${
          persent1 === persent2 && persent1 === 100 ? "Trên" : "Từ"
  ...
  return (
    <div
      ...
      className="w-full h-full z-20 ml-[-18px] bg-opacity-20 bg-black flex items-center justify-center fixed"
    >
      <div
        onClick={(e) => {
          e.stopPropagation();
      ...
      >
        ...
        {(name === "price" || name === "area") && (
          <button
            type="button"
            className="w-full absolute bottom-0 left-0 bg-[#FFA500] text-center py-2 font-medium rounded-bl-md rounded-br-md"
